    ...
    def _name_search(self, name, args=None, operator='ilike', limit=100, name_get_uid=None):
        ...
        if name:
            ...
            if operator in positive_operators:
                product_ids = list(self._search(['|', ('default_code', '=', name), ('x_part_number', '=', name)] + args, limit=limit, access_rights_uid=name_get_uid))
                if not product_ids:
            ...
            if not product_ids and operator not in expression.NEGATIVE_TERM_OPERATORS:
                ...
                product_ids = list(self._search(args + ['|', ('default_code', operator, name), ('x_part_number', operator, name)], limit=limit))
                ...
                domain = expression.OR([
                    ...
                    ['&', ('x_part_number', operator, name), ('name', operator, name)],
                    ['&', ('x_part_number', '=', False), ('name', operator, name)],
                ])
            ...
            if not product_ids and operator in positive_operators:
                ...
                if res:
                    product_ids = list(self._search(['|', ('default_code', '=', res.group(2)), ('x_part_number', '=', res.group(2))] + args, limit=limit, access_rights_uid=name_get_uid))
